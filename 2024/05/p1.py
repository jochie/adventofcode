...
def parse_options():
    ...
    parser = argparse.ArgumentParser(
        description='This program is used for one of the AoC 2024 puzzles; Day 5, part 1'
    )
...
def main():
    ...
    for line in sys.stdin:
        ...
        if line == ",".join(sorted_list):
            middle_total += int(pagelist[int((len(pagelist)-1)/2)])

    print(f"Combined middle values of sorted lists: {middle_total}")
    return 0
