...
def main():
    ...
    while True:
        ...
        if to_key(height - 1, width - 2) in positions:
            print(f"We've reached the exit in {minute} minutes!")
            sys.exit(1)
        if len(positions) == 0:
